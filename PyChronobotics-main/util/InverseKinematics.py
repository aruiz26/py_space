...
class RobotArmInverseKinematicsSolver:
    ...
    def forward_kinematics(self, theta):
        ...
        x = self.f1(theta1, theta2, theta3)
        y = self.f2(theta1, theta2, theta3)
        z = self.f3(theta1, theta2, theta3)
    ...
    def f1(self, theta1, theta2, theta3):
