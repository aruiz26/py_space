...
parts = chrono.ImportSolidWorksSystem('./lander.py')
...
bbody    = mysystem.SearchBody('lander-2')
bbody.SetFixed(False)

bbody.SetPos(chrono.ChVector3d(0,1.5,0) )
bbody.SetRot(chrono.ChQuaterniond(1.5*3.14, 1, 0, 0)) # quat(mag, xdir, ydir, zdir)
...
terrain.SetPlane(chrono.ChCoordsysd(chrono.ChVector3d(0,-2,0), chrono.QuatFromAngleX(-math.pi/2)))
terrain.Initialize(2.0, 2.0, 0.04)
